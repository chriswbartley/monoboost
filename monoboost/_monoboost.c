 ...
 */
        __pyx_t_5 = (((__pyx_v_mt_feat_types[__pyx_v_j]) != 0.0) != 0);
        if (__pyx_t_5) {
 ...
 *                     else: # strict
 */
            __pyx_t_5 = (((((__pyx_v_X[((__pyx_v_i * __pyx_v_n_features) + __pyx_v_j)]) * __pyx_v_dirn) * (__pyx_v_mt_feat_types[__pyx_v_j])) < (((__pyx_v_rule_corners_MT[((__pyx_v_r * __pyx_v_n_features) + __pyx_v_j)]) * __pyx_v_dirn) * (__pyx_v_mt_feat_types[__pyx_v_j]))) != 0);
            if (__pyx_t_5) {
 ...
 *             else:
 */
      __pyx_t_5 = ((__pyx_v_nmt_dot_sum >= 0.) != 0);
      if (__pyx_t_5) {
  ...
  __Pyx_RefNannySetupContext("apply_rules_c (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_rule_corners_MT)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("apply_rules_c", 1, 8, 8, 1); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_rule_hyperplanes_NMT)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("apply_rules_c", 1, 8, 8, 2); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_rule_intercepts_NMT)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("apply_rules_c", 1, 8, 8, 3); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mt_feat_types)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("apply_rules_c", 1, 8, 8, 4); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dirn)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("apply_rules_c", 1, 8, 8, 5); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_strict)) != 0)) kw_args--;
        else {
 ...
 *                   object rule_hyperplanes_NMT,
 */
  __pyx_tuple__10 = PyTuple_Pack(8, __pyx_n_s_X, __pyx_n_s_rule_corners_MT, __pyx_n_s_rule_hyperplanes_NMT, __pyx_n_s_rule_intercepts_NMT, __pyx_n_s_mt_feat_types, __pyx_n_s_dirn, __pyx_n_s_strict, __pyx_n_s_out); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(8, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_monoboost_pyx, __pyx_n_s_apply_rules_c, 97, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_monoboost(void); /*proto*/
PyMODINIT_FUNC init_monoboost(void)
#else
PyMODINIT_FUNC PyInit__monoboost(void); /*proto*/
PyMODINIT_FUNC PyInit__monoboost(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec__monoboost(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__monoboost(void)", 0);
