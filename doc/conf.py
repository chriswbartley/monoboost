...
latex_documents = [
  ('index', 'monoboost.tex', 'monoboost Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'monoboost', 'monoboost Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'monoboost', 'monoboost Documentation',
   'Ariel Rokem', 'monoboost', 'One line description of project.',
   'Miscellaneous'),
]
