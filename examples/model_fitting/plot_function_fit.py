"""
================================
Fitting a function with monoboost
================================

Monoboost contains a number of tools for fitting functions to
data. This example shows us how to load data into python, fit
a function to our datapoints with monoboost, and then plot the
result.
...
# ------------
#
# First, we'll load some data into monoboost.
...
# ---------------
#
# With monoboost, models are created with the :ref:Model class.
